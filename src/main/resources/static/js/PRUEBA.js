...
function pintarRespuestaSkate(response) {
  ...
  for (i = 0; i < response.length; i++) {
    ...
    myTable +=
      '<td><button class = "botonSkate2" onclick="borrar(' +
      response[i].id +
      ')">Borrar Skate!</button></td>';
    myTable +=
      '<td><button class = "botonSkate2" onclick="cargarDatosSkate(' +
      response[i].id +
      ')">Editar Skate!</button></td>';
    myTable +=
      '<td><button class = "botonSkate2" onclick="actualizar(' +
      response[i].id +
      ')">Actualizar Skate!</button></td>';
    myTable += "</tr>";
  }
  myTable += "</table>";
